...
complete -c paii -n "__fish_paii_using_subcommand help; and not __fish_seen_subcommand_from plugin hook history config registry run status completions help" -f -a "plugin" -d 'Manage plugins'
complete -c paii -n "__fish_paii_using_subcommand help; and not __fish_seen_subcommand_from plugin hook history config registry run status completions help" -f -a "hook" -d 'Handle hook events from Claude Code'
complete -c paii -n "__fish_paii_using_subcommand help; and not __fish_seen_subcommand_from plugin hook history config registry run status completions help" -f -a "history" -d 'Query and manage history'
complete -c paii -n "__fish_paii_using_subcommand help; and not __fish_seen_subcommand_from plugin hook history config registry run status completions help" -f -a "config" -d 'Manage configuration'
complete -c paii -n "__fish_paii_using_subcommand help; and not __fish_seen_subcommand_from plugin hook history config registry run status completions help" -f -a "registry" -d 'Manage plugin registries'
complete -c paii -n "__fish_paii_using_subcommand help; and not __fish_seen_subcommand_from plugin hook history config registry run status completions help" -f -a "run" -d 'Run a plugin action directly'
complete -c paii -n "__fish_paii_using_subcommand help; and not __fish_seen_subcommand_from plugin hook history config registry run status completions help" -f -a "status" -d 'Show system status'
complete -c paii -n "__fish_paii_using_subcommand help; and not __fish_seen_subcommand_from plugin hook history config registry run status completions help" -f -a "completions" -d 'Generate shell completions'
complete -c paii -n "__fish_paii_using_subcommand help; and not __fish_seen_subcommand_from plugin hook history config registry run status completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
